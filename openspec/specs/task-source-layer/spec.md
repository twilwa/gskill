...
Define the canonical task model and task-source boundary that `gskill` uses to build optimization-ready task bundles independently from any single dataset adapter.
