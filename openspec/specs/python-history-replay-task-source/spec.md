...
Define the repo-native Python history replay source that mines validated fix commits from git history and turns them into canonical local-checkout repair tasks.
