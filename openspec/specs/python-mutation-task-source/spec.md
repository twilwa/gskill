...
Define the repo-native Python mutation source and local-checkout execution path that let `gskill` synthesize canonical repair tasks from a real repository checkout.
